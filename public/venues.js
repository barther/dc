...
(function (root) {
  ...
  const venues = [
    ...
    { id: "national-christmas-tree", ll: [38.8946, -77.0366], name: "National Christmas Tree", seed: 11, priority_tier: "protected", period: "night", load: "mid", environment: "outdoor",
      min_hours: 0.5, ideal_hours: 1, shortenable: true, reservation: "none",
      weather: { rain: "poor", cold: "good", wind: "acceptable", heat: "good" }, bundle: "christmas-washington", constraints: { weekdays: [], holidays: [], season: { from: "12-04", to: "01-01", note: "lit from the first Thursday of December; dates vary by year" } } },
    ...
    { id: "zoolights", ll: [38.9296, -77.0498], name: "ZooLights", seed: 23, priority_tier: "bonus", period: "night", load: "mid", environment: "outdoor",
      min_hours: 1.5, ideal_hours: 2.5, shortenable: true, reservation: "recommended",
      weather: { rain: "poor", cold: "good", wind: "acceptable", heat: "good" }, bundle: null, constraints: { weekdays: [], holidays: [], season: { from: "11-21", to: "01-03", note: "typical dates; check the year's" } } },
    { id: "holiday-market", ll: [38.8953, -77.0223], name: "DowntownDC Holiday Market", seed: 24, priority_tier: "bonus", period: "day", load: "lo", environment: "outdoor",
      ...
      weather: { rain: "poor", cold: "good", wind: "acceptable", heat: "good" }, bundle: "christmas-washington", constraints: { weekdays: [], holidays: [], season: { from: "11-21", to: "12-23", note: "typical dates; check the year's" } } },
