...
(function (root) {
  ...
  const venues = [
    { id: "rockefeller-christmas", ll: [40.7587, -73.9787], name: "Rockefeller Center Christmas Tree", seed: 1, priority_tier: "protected", period: "night", load: "mid", environment: "outdoor",
      min_hours: 0.75, ideal_hours: 1.5, shortenable: true, reservation: "none", weather: OUTDOOR_XMAS, bundle: "rockefeller-christmas", constraints: { weekdays: [], holidays: [] } },
    ...
    { id: "fifth-avenue-christmas", ll: [40.759, -73.977], name: "Fifth Avenue Christmas windows", seed: 11, priority_tier: "high", period: "night", load: "mid", environment: "outdoor",
      min_hours: 1.5, ideal_hours: 2.5, shortenable: true, reservation: "none", weather: OUTDOOR_XMAS, bundle: "rockefeller-christmas", constraints: { weekdays: [], holidays: [] } },
    ...
    { id: "bryant-park", ll: [40.7536, -73.9832], name: "Bryant Park Winter Village", seed: 13, priority_tier: "high", period: "night", load: "mid", environment: "outdoor",
      min_hours: 1, ideal_hours: 2, shortenable: true, reservation: "none", weather: OUTDOOR_XMAS, bundle: null, constraints: { weekdays: [], holidays: [] } },
    ...
    { id: "radio-city-christmas", ll: [40.76, -73.98], name: "Radio City Christmas Spectacular", seed: 15, priority_tier: "medium", period: "night", load: "mid", environment: "indoor",
      min_hours: 2, ideal_hours: 2.5, shortenable: false, reservation: "required", weather: INDOOR_ALL, bundle: null, constraints: { weekdays: [], holidays: [] } },
    ...
    { id: "macys-herald-square", ll: [40.7508, -73.9895], name: "Macy's Herald Square", seed: 26, priority_tier: "bonus", period: "day", load: "lo", environment: "mixed",
      min_hours: 1, ideal_hours: 2, shortenable: true, reservation: "none", weather: { rain: "good", cold: "excellent", wind: "good", heat: "good" }, bundle: null, constraints: { weekdays: [], holidays: ["christmas"] } },
